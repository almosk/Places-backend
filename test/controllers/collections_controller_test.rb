...
class CollectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collection" do
    assert_difference('Collection.count') do
      post collections_url, params: { collection: { city_id: @collection.city_id, title: @collection.title, user_id: @collection.user_id } }
    end
  ...
  test "should update collection" do
    patch collection_url(@collection), params: { collection: { city_id: @collection.city_id, title: @collection.title, user_id: @collection.user_id } }
